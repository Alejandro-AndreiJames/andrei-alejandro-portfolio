...
function Experience() {
  return (
    <section id="experience" className="border-t border-border px-8 py-24">
      <div className="mx-auto max-w-6xl">
        <p className="mb-6 text-sm font-semibold uppercase tracking-[0.2em] text-accent">
          Experience
        </p>

        <div className="grid items-stretch gap-10 lg:grid-cols-[0.7fr_1.3fr]">
          <div className="flex flex-col">
            ...
            <p className="mt-6 max-w-md leading-7 text-muted">
              From internship to a full-time role, I’ve been shipping web and
              iOS features, improving quality through testing, and learning how
              production software is built and maintained day to day.
            </p>
          </div>
          ...
          <article className="glass rounded-2xl border border-border bg-surface p-6 sm:p-8">
            <div className="flex flex-col justify-between gap-4 sm:flex-row">
              ...
              <div className="sm:text-right">
                <p className="text-sm text-muted">March 2025 – Present</p>
